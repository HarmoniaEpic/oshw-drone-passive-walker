...
"""Balloon-stabilized kneed passive walker with a pair of azimuth ducted fans.
...
M_BAL   = 0.25          # balloon envelope + mast (lumped at attach point)
M_TH, M_SH = 0.22, 0.20
...
p.setCollisionFilterGroupMask(walker, BAL, 0, 0)   # balloon: no collisions
...
KD_BAL  = 0.35           # balloon aerodynamic drag [N s/m]
